...
# print(inputArray)
byte_arr = [
    first[inputArray[0] % len(first)],
    bool(inputArray[1] % 2),
    float(inputArray[2]) / 1000.0,
    float(inputArray[3]) / 1000.0,
    bool(inputArray[4] % 2),
    float(inputArray[5]) / 1000.0,
...
model = LogisticRegression(
    ...
    tol=byte_arr[2],
    C=byte_arr[3],
    fit_intercept=byte_arr[4],
    intercept_scaling=byte_arr[5],
    solver=byte_arr[6],
    max_iter=byte_arr[7],
    multi_class=byte_arr[8],
    l1_ratio=byte_arr[9],
)
